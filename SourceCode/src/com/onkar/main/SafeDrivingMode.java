...
public class SafeDrivingMode extends AbstractDrivingMode {

	static final String safeDrivingPropertiesFile = "SafeDrivingProperties.properties";
	...
	public SafeDrivingMode(String mode) {
		super();
