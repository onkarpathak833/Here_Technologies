 ...
 * 
 * */
public class NormalDrivingMode extends AbstractDrivingMode {

	static final String safeDrivingPropertiesFile = "NormalDrivingProperties.properties";
	...
	public NormalDrivingMode(String mode) {
		super();
